...
export default function MusicCollection() {
  ...
  const filteredAndSortedTracks = useMemo(() => {
    ...
    const filtered = tracks.filter(track => {
      ...
      const statusMatch = statusFilter === 'TODOS' || track.status_processamento === statusFilter;
  ...
  }, [tracks, searchQuery, statusFilter, typeFilter, sortBy, sortOrder])
          ...
          <div className="liquid-glass rounded-xl p-6">
              ...
              <div className="flex flex-wrap gap-x-4 gap-y-2 items-center">
                 ...
                 <div className="relative">
                       <select
                           ...
                           className="appearance-none bg-white/10 border border-white/20 rounded-lg pl-3 pr-8 py-1.5 text-white text-xs focus:ring-1 focus:ring-primary cursor-pointer"
                       >
                           <option className="bg-bg-dark-primary text-white" value="TODOS">Status: Todos</option>
                           <option className="bg-bg-dark-primary text-white" value="PROCESSADO">Status: Processado</option>
                           <option className="bg-bg-dark-primary text-white" value="PENDENTE">Status: Pendente</option>
                           <option className="bg-bg-dark-primary text-white" value="ERRO">Status: Erro</option>
                       </select>
                       <span className="material-symbols-outlined absolute right-2 top-1/2 -translate-y-1/2 text-text-muted pointer-events-none text-base">expand_more</span>
                   </div>
                    <div className="relative">
                 ...
                 <button
                       ...
                       className="p-1.5 bg-white/10 border border-white/20 rounded-lg text-white hover:bg-white/20 transition-colors"
            ...
            <div className="flex items-center p-3 rounded-lg bg-white/5 mb-2">
                 ...
                 <div className="flex items-center gap-4 flex-shrink-0 ml-4">
                      <span className="text-xs font-semibold text-text-muted w-[76px] text-center">STATUS</span>
              ...
              {filteredAndSortedTracks.map((track) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4 flex-shrink-0 ml-4">
                      <span className={`text-xs font-bold px-2 py-0.5 rounded-full w-[76px] text-center ${getStatusChip(track.status_processamento)}`}>{track.status_processamento}</span>
